...
var Banned = React.createClass({displayName: "Banned",
...
var GameStatus = React.createClass({displayName: "GameStatus",
    ...
    render : function() {
        ...
        if (this.props.game.id === undefined) {
            content = React.createElement("div", {className: "alert alert-info"}, "The next lottery has not been created yet. Check back later.");
            ...
            if (this.props.game.lottery_run === '1') {
                ...
                if (this.props.lottery) {
                    ...
                    if (this.props.lottery.winner === '1') {
                        ...
                        if (this.props.lottery.confirmed === '1') {
                            ...
                            if (this.props.lottery.spot_id !== '0') {
                                if (this.props.lottery.picked_up === '1') {
                                    content = React.createElement("div", {className: "alert alert-info"}, "Your tailgate tag has been picked up. Enjoy the game!");
                                ...
                                if (this.props.game.pickup_deadline < timestamp) {
                                    content = React.createElement("div", {className: "alert alert-info"}, "Sorry, you failed to confirm your tailgating win. Your spot has been forfeited.");
                                } else {
                                    content = React.createElement("div", null, React.createElement(ConfirmSpot, {lottery: this.props.lottery, loadData: this.props.loadData}));
                                }
                            }
                        } else {
                        ...
                        content = React.createElement("div", {className: "alert alert-info"}, "Sorry, you did not win a spot this time. Try again next game.");
                    }
                } else {
                    // student did not submit a ticket for current lottery
                    content = React.createElement("div", {className: "alert alert-danger"}, "The lottery is complete and the winners have been contacted. Please, try again next game.");
                }
            } else {
                ...
                if (timestamp >= this.props.game.signup_end) {
                    ...
                    if (this.props.lottery) {
                        ...
                        content = React.createElement("div", {className: "alert alert-info"}, "Your application has been submitted. Watch your email and check back later for lottery results.");
                    } else {
                        // the student didn't submit a ticket.
                        content = React.createElement("div", {className: "alert alert-info"}, "Sorry, you missed the lottery sign up deadline. Try again next game.");
                    }
                } else if (this.props.game.signup_start <= timestamp) {
                    // the sign up start has passed.
                    if (this.props.lottery) {
                        // the student submitted a ticket.
                        content = React.createElement("div", {className: "alert alert-info"}, "Your application has been submitted. Check your email after ", this.props.game.signup_end_format, " for lottery results.");
                    } else {
                    ...
                    content = React.createElement("div", {className: "alert alert-success"}, "Tailgate lottery for this game begins at ", React.createElement("strong", null, this.props.game.signup_start_format), ". See you then!");
                }
            }
        }
        return content;
...
var ConfirmSpot = React.createClass({displayName: "ConfirmSpot",
    getInitialState: function() {
        return {
            availableSpots: [],
            message : null,
    ...
    confirmSpot : function() {
        ...
        $.post('tailgate/User/Lottery', {
            ...
            if (data.success) {
                ...
                this.setState({
                    message : React.createElement("div", {className: "alert alert-danger"}, "Your requested spot was chosen by someone else. Pick again.")
                });
                this.loadAvailableSpots();
            }
        }.bind(this));
...
var LotterySubmit = React.createClass({displayName: "LotterySubmit",
    render : function() {
...
var Waiting = React.createClass({displayName: "Waiting",
    render : function() {
        return (
            React.createElement("div", {className: "alert alert-success"}, React.createElement("i", {className: "fa fa-cog fa-spin fa-lg"}), " Please wait...")
        );
    }
});
